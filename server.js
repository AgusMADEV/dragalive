...
/*******************************************************************
  server_ssl.js
  -------------
  1) Creates an HTTPS + WebSocket server on https://evoluciona.es:3000
  ...
  HOW TO RUN:
    ...
    3) Open https://evoluciona.es:3000

  Make sure:
    - Your DNS points evoluciona.es to this server.
    - You have a valid SSL cert + key for evoluciona.es.
 ...
 */
const SSL_CERT_PATH = '/etc/apache2/ssl/evoluciona_combined.cer';
const SSL_KEY_PATH  = '/etc/apache2/ssl/evoluciona.key';
 ...
 * So the URL will be https://evoluciona.es:3000
 */
const PORT = 3000;
 ...
 */
server.listen(PORT, () => {
  console.log(`HTTPS + WebSocket server running at https://evoluciona.com:${PORT}`);
